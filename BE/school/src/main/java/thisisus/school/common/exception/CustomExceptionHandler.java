...
public class CustomExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> dtoValidation(MethodArgumentNotValidException e) {
        ErrorResponse error = ErrorResponse.from(ExceptionCode.INVALID_INPUT);
        return ResponseEntity.status(error.getHttpStatus()).body(error);
    }
}
