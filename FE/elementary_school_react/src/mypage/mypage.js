...
return(
    <div>
        ...
        <div className={style.myJBottom} onClick={myJshowClick}>회원 탈퇴</div>
        </div>
        {myJuserDropShow && (
        <div className={`${style.myJCenter} ${style.myJdropUser}`}>
            <div className={style.myJuserDropContent}>
                ...
                <div className={style.myJdropFlex}>
                    <Link to="/" className={style.myJdropButton} style={{backgroundColor: '#91C8E4'}}>예</Link> 
                    <div className={style.myJdropButton} 
                    style={{backgroundColor: '#4682A9', color:'white'}} 
                    onClick={myJdropClick}>아니요</div>
                </div>
            </div>
        </div>
        )}
