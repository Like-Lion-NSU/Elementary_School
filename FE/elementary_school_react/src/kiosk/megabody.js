...
import img2 from "./img/mega_body/mega_ice.jpg";
      ...
      <div className="bodySection">
        <table>
          <tbody>
            <tr>
              <td>
                <img src={img1} width="230" height="240"></img>
                <div className="info">
            ...
            <tr>
              <td>
                <img src={img3} width="230" height="240"></img>
                <div className="info">
              ...
              <td>
                <img src={img4} width="230" height="240"></img>
                <div className="info">
              ...
              <td>
                <img src={img5} width="230" height="240"></img>
                <div className="info">
              ...
              <td>
                <img src={img6} width="230" height="240"></img>
                <div className="info">
            ...
            <tr>
              <td>
                <img src={img7} width="230" height="240"></img>
                <div className="info">
              ...
              <td>
                <img src={img8} width="230" height="240"></img>
                <div className="info">
