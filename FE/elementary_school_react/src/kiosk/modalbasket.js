...
import { faXmark, faCircleChevronRight, faArrowLeft, faStore, faGlassWater } from '@fortawesome/free-solid-svg-icons';
    ...
    >
      <div className="baJBasket">
        ...
        <div className="baJOption">
            <div className="baJLeftMargin"><FontAwesomeIcon icon={faCircleChevronRight}/> 샷 추가</div>
            <div className="baJRight">1개</div>
        ...
        <div className="baJOption">
            <div className="baJLeftMargin"><FontAwesomeIcon icon={faCircleChevronRight}/> 연하게</div>
            <div className="baJRight">1개</div>
        ...
        <div className="baJOption">
            <div className="baJLeftMargin"><FontAwesomeIcon icon={faCircleChevronRight}/> 휘핑O</div>
            <div className="baJRight">1개</div>
            <div className="baJRight">0원</div>
        </div>
