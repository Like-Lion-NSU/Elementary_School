  ...
  return (
    <div className={style.loJCenter}>
      ...
      <div className={style.loJLoginTitle}>
        ...
        <h2 style={{ color: "#4682A9" }} className={style.loJIcon}>
          <FontAwesomeIcon
            icon={faInfoCircle}
        ...
        {showInfo && (
          <div className={style.loJInfo}>
            <b>로그인 안내</b> <hr />
            <b>국민학교</b>는 서비스 간편화를 위해 <br />
            카톡/구글의 간편로그인만 제공합니다
          </div>
        )}
      </div>
      ...
      <div className={style.loJFlex}>
        <a
          ...
          href="http://localhost:8081/login/oauth2/authorization/kakao"
        >
          <img
            src={Lo_J_KakaoLogin}
        ...
        <a
          className={style.loJLogin_Btn}
          href="http://localhost:8081/login/oauth2/authorization/google"
        >
          <img
